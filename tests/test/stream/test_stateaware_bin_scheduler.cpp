...
class StateAwareSchedulerTestFixture : public BatchSchedulerFixture
{
  public:
    StateAwareSchedulerTestFixture()
    {
        conf.batchSchedulerMode = "state-aware";
        batchScheduler = getBatchScheduler();
    }
};

// For the non-state-funciton, it should acts as the binpack!
TEST_CASE_METHOD(StateAwareSchedulerTestFixture,
                 "Test scheduling of new requests with StateAware",
                 "[stateaware-bin-scheduler]")
{
...
TEST_CASE_METHOD(StateAwareSchedulerTestFixture,
                 "Test scheduling of scale-change requests with StateAware",
                 "[stateaware-bin-scheduler]")
{
...
TEST_CASE_METHOD(StateAwareSchedulerTestFixture,
                 "Test scheduling of dist-change requests with Stateaware",
                 "[stateaware-bin-scheduler]")
{
